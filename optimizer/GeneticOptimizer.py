...
class SimpleGAOptimizer(GeneticAlgorithmOptimizer):
    def __init__(self, initialPopulation, costEvaluator, GAParameters : SimpleGAParameters, minBounds=None, maxBounds=None):
        super().__init__(initialPopulation, costEvaluator)
        self.GAParameters : SimpleGAParameters = GAParameters
...
# hack
    ...
    def getWeightedChoiceList(self, population, costsList):
        ...
        # mask to remove NaN or values that are too large. Need to fix up. Use log?
